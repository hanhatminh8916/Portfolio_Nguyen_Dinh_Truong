  ...
  head: () => ({
    meta: [
      ...
      { title: "Nguyễn Đình Trường — AIoT & Robotics Engineer" },
      {
        name: "description",
        content:
          "Portfolio của Nguyễn Đình Trường, sinh viên Trí tuệ Nhân tạo tại VKU. Dự án Robotics, AIoT và Embedded Systems.",
      },
      { name: "author", content: "Nguyễn Đình Trường" },
      { property: "og:title", content: "Nguyễn Đình Trường — AIoT & Robotics Engineer" },
      {
        property: "og:description",
        content: "Sinh viên AI tại VKU. Robotics, Embedded Systems, AIoT.",
      },
