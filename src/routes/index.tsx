...
const CV_URL = publicAsset("cv/Nguyen_Dinh_Truong.pdf");
    ...
    <section id="top" className="relative overflow-hidden">
      <div className="container-portfolio grid items-center gap-12 py-20 md:py-28 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
        ...
        <div className="reveal">
          ...
          >
            <p>
              Tôi là Nguyễn Đình Trường, sinh viên ngành Trí tuệ Nhân tạo tại VKU. Chương trình đào
              tạo giúp tôi hiểu cách máy tính học từ dữ liệu, nhận diện thông tin và đưa ra quyết
              định. Tuy nhiên, điều khiến tôi hứng thú hơn cả là ứng dụng những khả năng đó vào các
              hệ thống thực tế, nơi AI không chỉ tồn tại trong mô hình mà trở thành một phần của
              robot và thiết bị thông minh.
            </p>
            <p>
              Vì vậy, bên cạnh việc học trên giảng đường, tôi chủ động tìm hiểu về Embedded Systems,
              vi điều khiển và Robotics. Tôi đã tham gia các cuộc thi kỹ thuật, đạt Giải Nhất
              RoboCar và Giải Nhì AIoT Smart Helmet. Nền tảng AI của tôi được xây dựng từ học thuật,
              còn tư duy Robotics được rèn luyện thông qua quá trình trực tiếp thiết kế, thử nghiệm
...
const PROJECTS: Project[] = [
  {
    ...
    videos: [
      { src: publicAsset("media/robocar/demo-01.mp4"), label: "Video xe dò line leo bậc thang" },
      { src: publicAsset("media/robocar/demo-02.mp4"), label: "Video xe điều khiển bắn bóng" },
    ],
  ...
  },
  {
    ...
    videos: [
      { src: publicAsset("media/helmet/demo-01.mp4"), label: "Video phát hiện té ngã" },
      { src: publicAsset("media/helmet/demo-02.mp4"), label: "Video mũ bảo hộ thông minh" },
    ],
  ...
  },
  {
    ...
    videos: [
      { src: publicAsset("media/dqn/demo-01.mp4"), label: "Video xe cân bằng di chuyển theo lane" },
      { src: publicAsset("media/dqn/demo-02.mp4"), label: "Video xe cân bằng với thuật toán PID" },
    ],
      ...
      <div className="container-portfolio py-24">
        <div className="reveal mb-16 max-w-2xl">
          ...
          <p className="mt-4 text-[15px] leading-relaxed text-muted-foreground">
            Ba dự án tiêu biểu thể hiện cách tôi kết hợp AI, Embedded Systems và Robotics để giải
        ...
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="reveal">
            ...
            <p className="mt-5 max-w-lg text-[15px] leading-relaxed text-muted-foreground">
              Tôi mong muốn tham gia các dự án và đội ngũ kỹ thuật nơi AI, Robotics và Embedded
              Systems được ứng dụng để giải quyết những bài toán thực tế.
            </p>
